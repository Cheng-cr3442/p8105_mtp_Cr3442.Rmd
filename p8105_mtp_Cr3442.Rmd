...
Then the number of bservations is 151, number of unique zip codes is 149, Number of unique neighborhoods is 43.
...
Explanation: Of all the Problem 1, I first imported the three datasets, then cleaned and merged them based on standardized column names, filtered and checked the merged dataset to ensure data consistency and integrity, and finally standardized the date column.
...
Comments: This could be because not all zip codes in New York City have enough rental properties to be included in the dataset, such as those with fewer rental listings. It could also be because rental data may be aggregated across multiple smaller zip codes.
...
Comments: Overall, rental prices in all boroughs showed an upward trend between 2015 and 2024. From 2020 to 2021, rental prices declined or remained stable, especially in Manhattan and Brooklyn, reflecting the lower demand in the rental market during the COVID-19 pandemic. Since 2022, rents have begun to recover significantly, indicating a strong rebound in rental demand after the pandemic.
...
Comments: According to the table, rental prices in Manhattan and Brooklyn were more significantly impacted during the epidemic, resulting in a sharp drop in rents, which may be because they are located in the downtown area with high rents and population density. Relatively speaking, the Bronx and Queens were less affected, which may be because the rents there are more economical and the living environment is more suitable for remote work.
...
Comments: Overall, rental prices in all boroughs of New York City have been on an upward trend, but between 2020 and 2021, rental prices have dropped significantly in all boroughs, especially in Manhattan. I think this is related to the trend of a large number of residents moving out of the city and choosing to work remotely during the epidemic. After that, rents quickly rebounded in 2022 and continued to rise, indicating that the rental market is gradually recovering after the epidemic.
...
Comments: The housing price curve shown in the figure shows a typical right-skewed distribution, with the average housing prices in most zip codes concentrated in the lower range (mainly between $0-2 million), and only a few zip codes have very high housing prices. This means that although there are some high-value areas, the housing prices in most areas are still acceptable to New York workers.
...
Comments: From the scatter plot, we can see that there is a clear positive correlation between rental prices and housing prices. As the average rental price increases, the average housing price also increases. Most of the data points are concentrated in the lower range of rental and housing prices, with average rents between $2,000 and $4,000, and corresponding housing prices between $1 million and $2 million. Only a few data points correspond to higher rental and housing prices.

### Question 4: analysis of limitations

Rent and housing data may be incomplete for some zip codes, especially in areas with relatively low rental activity. Data is concentrated in specific areas: The data is concentrated in specific areas of New York City, such as Manhattan, Brooklyn, etc. These areas have relatively high rents and house prices, but they cannot fully represent the situation in New York City as a whole, especially in remote or less densely populated areas. Therefore, the data may have sample representativeness bias and cannot cover the housing market situation in New York City as a whole. The dataset is aggregated by zip code, which is likely to ignore price differences within zip codes. Because even in the same zip code, house prices and rents between different locations may vary greatly, this lack of detail may cause us to underestimate the heterogeneity within the region.
